...
def init_browser():
    ...
    # return Browser('chrome', **executable_path, headless=False)
    exec_path = {'executable_path': 'C:\\Users\\dsrivastava\\Desktop\\Dewesh_HW\\Mars---the-4th-planet\\chromedriver.exe'}
